...
namespace EntityTesting.Models
{
    public partial class AdventureDbContext : DbContext
    {
        ...
        public virtual DbSet<_select_> _select_s { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(
                "Data Source=DESKTOP-94PAMUT\\MSSQLSERVER01;Initial Catalog=AdventureWorks;Persist Security Info=True;User ID=LoginForRider; Password = 111");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Address>(entity =>
            {
                ...
                entity.HasIndex(
                    e => new { e.AddressLine1, e.AddressLine2, e.City, e.StateProvince, e.PostalCode, e.CountryRegion },
            ...
            modelBuilder.Entity<ProductCategory>(entity =>
            {
                ...
                entity.Property(e => e.ParentProductCategoryID).HasComment(
            ...
            modelBuilder.Entity<_select_>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("\"select\"");

                entity.Property(e => e._identity_)
                    .ValueGeneratedOnAdd()
                    .HasColumnName("\"identity\"");

                entity.Property(e => e._order_).HasColumnName("\"order\"");
            });
